...
class WatuPROFlashcard {
	...
	static function process($class, $ans, $compare, $sr_text) {
		...
		if(strstr($class, 'correct-answer')) $result_image = '<img src="'.plugins_url("watupro").'/correct.png" hspace="10">';
		else $result_image = '<img src="'.plugins_url("watupro").'/wrong.png" hspace="10">';
