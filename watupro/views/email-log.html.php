...
<div class="wrap">
	...
	<div class="postbox wp-admin" style="padding:20px;">
		<form method="post">
			...
			<br>
			<?php _e('Automatically cleanup old logs after', 'watupro')?> <input type="text" size="4" name="cleanup_days" value="<?php echo $cleanup_raw_log?>"> <?php _e('days', 'bftpro')?> <input type="submit" name="cleanup" value="<?php _e('Set Cleanup', 'watupro')?>"> </p>
		</form>		
	...
	<th><?php _e('Subject', 'bftpro')?></th><th><?php _e('Response from the mailing server', 'watupro')?></th>	</tr>
				</thead>
				<tbody>
