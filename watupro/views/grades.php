<div class="wrap watupro-wrap">
	<?php if(empty($in_default_grades)):?>
		...
		<form method="post">
			<div style='display:<?php echo (empty($exam->reuse_default_grades) and count($cats)) ? 'block' : 'none';?>'>
