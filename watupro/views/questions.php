...
<div class="wrap watupro-wrap">
	...
	&nbsp;|&nbsp;
	<a href="admin.php?page=watupro_copy_exam&id=<?php echo $_GET['quiz']?>&comefrom=questions"><?php printf(__('Copy %s and / or questions', 'watupro'), WATUPRO_QUIZ_WORD)?></a></p>
...
<div id="watuProQuestions" <?php echo $intelligence_display;?>>
	...
	<form method="get" action="admin.php">
		...
		&nbsp;
		<?php _e('and tagged as:', 'watupro')?> <input type="text" name="filter_tag" value="<?php echo @$_GET['filter_tag']?>"> <br>
		...
		<?php endif;?>
		<?php _e('with ID (you can separate multiple IDs with comma):', 'watupro')?> <input type="text" name="filter_id" value="<?php echo @$_GET['filter_id']?>" size="6"> 
		&nbsp;
		<?php _e('and question contains (phrase):', 'watupro');?> <input type="text" name="filter_contents" value="<?php echo @$_GET['filter_contents']?>">
   ...
   <form method="post" action="admin.php?page=watupro_questions&quiz=<?php echo $_GET['quiz']?>">
	...
	<p align="center"><?php if($offset > 0):?>
		<a href="admin.php?page=watupro_questions&quiz=<?php echo $exam->ID?>&filter_cat_id=<?php echo @$_GET['filter_cat_id']?>&filter_tag=<?php echo @$_GET['filter_tag']?>&filter_id=<?php echo @$_GET['filter_id']?>&filter_dlevel=<?php echo @$_GET['filter_dlevel']?>&filter_contents=<?php echo @$_GET['filter_contents']?>&offset=<?php echo $offset - $page_limit?>"><?php echo _wtpt(__('Previous page', 'watupro'));?></a>
	<?php endif;?>
		<?php if($num_questions > ($offset + $page_limit)):?>
			&nbsp; <a href="admin.php?page=watupro_questions&quiz=<?php echo $exam->ID?>&filter_cat_id=<?php echo @$_GET['filter_cat_id']?>&filter_tag=<?php echo @$_GET['filter_tag']?>&filter_id=<?php echo @$_GET['filter_id']?>&filter_dlevel=<?php echo @$_GET['filter_dlevel']?>&filter_contents=<?php echo @$_GET['filter_contents']?>&offset=<?php echo $offset + $page_limit?>"><?php echo _wtpt(__('Next page', 'watupro'))?></a>
		<?php endif;?>	
	</p>
	...
	<div align="center" style="display:none;" id="massDeleteQuesions"><p>
	<?php if(count($qcats)): 
