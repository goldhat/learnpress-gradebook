...
<div id="postdiv" class="postarea">
	<div class="postbox watupro-tab-div" id="generalsettings">
		<div class="inside" style="padding:8px">
			...
			<div class="inside" style="padding:8px">
				...
				<h2 class="hndle"><?php _e('Default Answer Type', 'watupro') ?></h2>
				<div class="inside" style="padding:8px">
					<?php 
				...
				<div class="inside" style="padding:8px">
					<p><input type="checkbox" name="auto_db_cleanup" value="1" <?php if(get_option('watupro_auto_db_cleanup')=='1') echo 'checked'?>> <?php _e('Automatically', 'watupro');?>
						...
						<?php printf(__('user submitted data older than %s days', 'watupro'), '<input type="text" size="5" name="auto_db_cleanup_days" value="'.get_option('watupro_auto_db_cleanup_days').'">');?>
						&nbsp;
	...
	<div class="postbox watupro-tab-div" id="themesettings" style="display:none;">
		<div class="inside" style="padding:8px">
			...
			<input type="checkbox" name="mathjax_problem" value="1" <?php if(!empty($ui['mathjax_problem'])) echo 'checked'?>> <?php _e("I'm using MathJax or similar LaTeX plugin and have problems with some question choices not being displayed.", 'watupro');?>
		</div>
		<div class="inside" style="padding:8px">
			<p class="submit">
				<input type="submit" value="<?php _e('Save Options', 'watupro') ?>" class="button-primary" />
		...
		<div class="inside">
			...
			<div>
				...
				<div class="postarea">
					...
					<p><?php printf(__('In the %s that do NOT use ajax for submitting you will be able to allow file uploads for open end questions. Set your size and file type limitations here. Note that your server may also imply limitations on the uploaded file size.', 'watupro'), WATUPRO_QUIZ_WORD_PLURAL)?></p>
