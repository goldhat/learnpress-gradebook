...
<p><?php _e('(All the variables can be used in grade descriptions as well.)', 'watupro')?></p>
	...
	<?php if(empty($edit_mode)):?><tr><td nowrap="true">%%ANSWERS-PAGINATED%%</td><td><?php _e('Same as %%ANSWERS%% but one question/answer is shown at a time with a numbered paginator at the bottom.', 'watupro');?></td></tr>
	<tr><td>%%SHORT_ANSWERS%%</td><td><?php _e("This variable will display the question along with user's answer without checkmarks or feedback. The variable is suitable for surveys or similar tests that do not have correct or wrong answers.", 'watupro');?></td></tr><?php endif;?>
